...
function tick() {
    ...
    ctx3.fillRect(itC / 5000 * maxW, maxH - (heater_temp - 20) * 3, 2, 2)
    
    ctx3.fillStyle = "#FFFF00";
    ctx3.fillRect(itC / 5000 * maxW, maxH - (fluid_temp - 20) * 3, 2, 2)

    ctx3.fillStyle = "#00FF00";
    ctx3.fillRect(itC / 5000 * maxW, maxH - (vessel_wall_temp - 20) * 3, 2, 2)

    ctx3.fillStyle = "#0000FF";
    ctx3.fillRect(itC / 5000 * maxW, maxH - (vessel_cont_temp - 20) * 3, 2, 2)
