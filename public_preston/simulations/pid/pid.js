...
function tick() {
    ...
    ctx3.fillRect(itC / 1000 * maxW, maxH - heater_temp * 1, 2, 2)
    
    ctx3.fillStyle = "#FFFF00";
    ctx3.fillRect(itC / 1000 * maxW, maxH - fluid_temp * 1, 2, 2)

    ctx3.fillStyle = "#00FF00";
    ctx3.fillRect(itC / 1000 * maxW, maxH - vessel_wall_temp * 1, 2, 2)

    ctx3.fillStyle = "#0000FF";
    ctx3.fillRect(itC / 1000 * maxW, maxH - vessel_cont_temp * 1, 2, 2)
    ...
    qdot_1 = (heater_temp - fluid_temp) * 400;

    // from heating fluid to vessel wall
    qdot_2 = (fluid_temp - vessel_wall_temp) * 400;

    // from vessel wall to vessel content
    qdot_3 = (vessel_wall_temp - vessel_cont_temp) * 400;
