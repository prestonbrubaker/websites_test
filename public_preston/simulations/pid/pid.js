...
function drawPFD() {
    ...
    ctx.lineTo(425, 50); // End point (x, y)
    ctx.lineTo(425, 100); // End point (x, y)
    ctx.stroke();
    ctx.beginPath();
    ctx.moveTo(125, 300); // Start point (x, y)
    ctx.lineTo(125, 350); // End point (x, y)
    ctx.lineTo(425, 350); // End point (x, y)
    ctx.lineTo(425, 300); // End point (x, y)
    ctx.stroke();
